...
$sql = "SELECT listsEvent.id as listeventid, lists.id as id, name, description, image, video, audio, date, time, done, help FROM listsEvent join lists on listid = lists.id where done is not null order by time, date";
