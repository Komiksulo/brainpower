...
$sql = "SELECT listsevent.id as listeventid, lists.id as id, name, description, image, video, audio, date, time, done, help FROM listsevent join lists on listid = lists.id order by time, date where done is null";
